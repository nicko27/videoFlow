...
class UnifiedConfigManager:
    ...
    def get_current_config(self) -> UnifiedConfig:
        """
        Get current unified configuration.

        Returns:
            Current UnifiedConfig instance
        """
        return self.config
    ...
    def migrate_from_qsettings(self, settings):
        ...
        try:
            ...
            # CORRECTION BUG #6: Import threshold normalization
            from ..utils.threshold_utils import normalize_threshold

            # Migrate comparison settings
            comparison = ComparisonConfig(
                threshold=normalize_threshold(get_value('threshold', 0.85, float)),
            ...
            audio_first = AudioFirstConfig(
                ...
                audio_threshold=normalize_threshold(get_value('audio_threshold', 0.85, float)),
            ...
            subsequence = SubsequenceConfig(
                ...
                threshold=normalize_threshold(get_value('subsequence_threshold', 0.85, float)),
