...
class BenchmarkRunner(QThread):
    ...
    def _precompute_hashes(self, pipeline_name: str, total_pairs: int, pipeline_config: Dict):
        ...
        try:
            ...
            # Étape 2 : signatures légères - OBSOLETE
            # NOTE: Signature precomputation removed - VideoAnalysisMethods has been replaced by DuplicateFlow
            # DuplicateFlow manages its own internal caching, no need for manual precomputation
        except Exception as e:
