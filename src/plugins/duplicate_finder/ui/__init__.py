...
__all__ = ['UIPanels', 'WidgetRegistry', 'get_widget_registry', 'SettingsDialog', 'DashboardView', 'BatchQueueWidget', 'ClusterViewDialog', 'SmartFiltersWidget', 'ReportDialog', 'Theme', 'ThemeType']
