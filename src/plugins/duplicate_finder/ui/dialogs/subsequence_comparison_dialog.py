...
try:
    ...
    from ...infrastructure.config.design_system import Colors, Spacing, Typography, Styles
    from ...infrastructure.config.keyboard_shortcuts import KeyboardShortcuts
except ImportError:
    from ..widgets.video_preview_widget import VideoPreviewWidget
